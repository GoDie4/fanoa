...
import { type noticiasValues } from '../../../shared/Interfaces';
import { DeleteItems } from '../../../shared/DeleteItems';
import { LoadingSmall } from '../../../shared/LoadingSmall';

export const ListaNoticias = (): JSX.Element => {
  ...
  const getAllProductos = async (): Promise<void> => {
    ...
    const request = await axios.post(`${Global.url}/getNoticias`, data, {
      headers: {
    ...
    <>
      ...
      {loadingComponents ? (
        ...
        <div className="bg-secondary-100 p-8 rounded-xl">
          ...
          {filterDate().map((pro: noticiasValues) => (
            <div
            ...
            >
              ...
              <div className="md:text-center">
                <h5 className="md:hidden text-white font-bold mb-2">Titulo</h5>
                <span>{pro.nombre_es}</span>
              </div>
