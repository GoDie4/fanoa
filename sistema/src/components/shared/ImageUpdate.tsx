...
export const ImageUpdate = ({
  ...
  const deleteImg = (e: MouseEvent<HTMLButtonElement>): void => {
    ...
    if (imgPreview !== null && iconImage != null && imagenInput !== null) {
      iconImage.classList.remove('d-none');
      imgPreview.classList.add('d-none');
      imagenInput.value = ''; // Limpia el campo de archivo
    }

    setImagen({ archivo: null, archivoName: '' }); // Indica que la imagen ha sido eliminada
    setUrl(''); // Vacía la URL
  };
